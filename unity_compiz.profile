...
[core]
s0_active_plugins = core;composite;opengl;decor;extrawm;gnomecompat;shift;place;compiztoolbox;mousepoll;imgpng;session;regex;vpswitch;grid;resize;move;notification;unitymtgrabhandles;wall;wobbly;animation;workarounds;expo;ezoom;fade;scale;unityshell;
...
s0_trigger_max_key = <Control><Alt>Return
...
s0_toggle_fullscreen_key = <Control><Alt>Return
